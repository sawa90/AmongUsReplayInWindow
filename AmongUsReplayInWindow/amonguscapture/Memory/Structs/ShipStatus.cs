...
namespace AmongUsCapture
{
    ...
    public class Doors
    {
        public static class skeld
        {
            ...
            {
                new float[]{ -6.7f,   1.7f,  -6.7f,    0.4f},
                new float[]{ -5.6f,  -13.9f, -5.6f,  -15.2f},
                new float[]{ -15f,    1.7f,  -15f,    0.3f },
                new float[]{ -1.6f,  -4.6f,  -0.2f,  -4.6f },
                new float[]{ -15f,   -11f,   -15f,   -12.4f},
                new float[]{ -17.8f, -1.7f,  -16.6f, -1.7f },
                new float[]{ -15f,   -4.8f,  -15f,   -6.2f},
                new float[]{  0.9f,  -11.6f,  0.9f,  -13f },
                new float[]{  4.8f,   1.7f,   4.8f,    0.4f  },
                new float[]{ -10.5f, -13.5f, -9.1f,  -13.5f},
                new float[]{ -10.1f, -0.7f,  -8.7f,  -0.7f },
                new float[]{ -17.8f, -9.2f,  -16.6f, -9.2f },
                new float[]{ -1.6f,  -8.8f,  -0.2f,  -8.8f }
            };
        ...
        public static class polus
        {
            public static float[][] Doors = new float[][]
                {
                new float[]{ 11.1f, -8.9f,  11.1f, -10.3f},
                ...
                new float[]{ 28.6f, -16.7f, 28.6f, -17.7f},
                new float[]{ 17.2f, -21.4f, 17.2f, -22.4f},
                new float[]{ 25.9f, -8.9f,  26.9f, -8.9f},
                new float[]{ 24.7f, -9.2f,  24.7f, -10.2f},
                new float[]{ 17.2f, -10.5f, 17.2f, -11.5f},
                new float[]{ 25.3f, -24.2f, 25.3f, -25.3f},
                new float[]{ 23.1f, -23.8f, 24.3f, -23.8f},
                new float[]{ 37.8f, -9.4f,  37.8f, -10.4f},
                new float[]{ 38.3f, -11.5f, 39.4f, -11.5f},
                };
